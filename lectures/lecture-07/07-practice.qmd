...
- [Mock-up quiz and practical examples!]{.alert}
:::
...
- **`@@ -0,0 +1 @@`** shows the line numbers affected, with `+` lines indicating additions and `-` lines indicating deletions
:::
:::
:::
...
![](figures/amend-message.png){width="100%"}
:::
:::
:::
:::
