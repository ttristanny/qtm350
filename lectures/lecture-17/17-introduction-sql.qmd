...
subtitle: Lecture 18 - Introduction to SQL
author:
  - name: Danilo Freire
...
format:
  clean-revealjs:
    self-contained: true
    code-overflow: wrap
    footer: "[Introduction to SQL](https://raw.githack.com/danilofreire/qtm350/main/lectures/lecture-18/18-introduction-sql.html)"
transition: slide
...
- Then follow these steps:
  ...
  - Add `C:\>sqlite` in your `PATH` environment variable and go to the command prompt and issue `sqlite3` command, which should display the following result
